...
export default function TransparentRoad(props: JSX.IntrinsicElements['group'] & { playerColor: string }) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <lineSegments geometry={nodes.Mesh_path_straight.geometry} material={playerMaterials[props.playerColor]} />
      <lineSegments geometry={nodes.Mesh_path_straight_1.geometry} material={materials.dirt} />
    </group>
  )
}
