...
export default function Model(props: JSX.IntrinsicElements['group'] & { roofColor: string }) {
  ...
  const roofMaterials: Record<string, THREE.Material> = React.useMemo(() => ({
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[-0.05, 0.2, -0.25]}>
        <lineSegments geometry={nodes.Mesh_building.geometry} material={roofMaterials[props.roofColor]} />
      ...
      <group position={[0.03, 0.2, 0.22]} rotation={[0, Math.PI / 4, 0]}>
        <lineSegments geometry={nodes.Mesh_building_3.geometry} material={roofMaterials[props.roofColor]} />
