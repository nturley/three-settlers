import { aH as WebGLRenderer, aI as Layers, a6 as Texture, s as sRGBEncoding, aJ as PCFSoftShadowMap, aK as ACESFilmicToneMapping, aL as Camera, C as Color, aM as THREE, aN as Clock, O as OrthographicCamera, P as PerspectiveCamera, aO as Scene, a as Vector2, aP as Raycaster, V as Vector3 } from './three.module-a38a28fd.js';
import { r as react, o as objectAssign } from './index-04edb6a1.js';
import { g as getDefaultExportFromCjs, c as createCommonjsModule } from './_commonjsHelpers-8c19dec8.js';
import { s as scheduler } from './index-4cc9f833.js';
import { m as mergeRefs } from './react-merge-refs.esm-309210cb.js';
...
function handleAsset(fn, cache, args, lifespan = 0, preload = false) {
  for (const entry of cache) {
    // Find a match
    if (fastDeepEqual(args, entry.args)) {
...
function clear(cache, ...args) {
  if (args === undefined || args.length === 0) cache.splice(0, cache.length);else {
    const entry = cache.find(entry => fastDeepEqual(args, entry.args));
...
useAsset.peek = (...args) => {
  ...
  return (_globalCache$find = globalCache.find(entry => fastDeepEqual(args, entry.args))) == null ? void 0 : _globalCache$find.response;
};
...
export { Canvas as C, useLoader as a, useAsset as b, useFrame as c, createPortal as d, useThree as u };
